...
@OnlyIn(Dist.CLIENT)
public class BabyFakePlayerRenderer extends LivingRenderer<FakePlayerEntity, FakePlayerModel<FakePlayerEntity>> {
    public BabyFakePlayerRenderer(EntityRendererManager renderManager) {
    ...
    public BabyFakePlayerRenderer(EntityRendererManager renderManager, boolean useSmallArms) {
