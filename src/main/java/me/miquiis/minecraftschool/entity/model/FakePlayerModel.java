...
public class FakePlayerModel<T extends LivingEntity> extends BipedModel<T> {
    ...
    public ModelRenderer getRandomModelRenderer(Random randomIn) {
        return (ModelRenderer)this.modelRenderers.get(randomIn.nextInt(this.modelRenderers.size()));
    }
